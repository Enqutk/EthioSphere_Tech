    ...
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      {loading ? (
        ...
        <ul className="mt-8 space-y-4">
          {challenges.map((c) => (
            <li key={c.id}>
              <Link href={`/challenges/${c.id}`} className="card block p-6 transition hover:border-brand-500/50">
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className={`rounded px-2 py-0.5 text-xs ${
                        ...
                        c.difficulty === 'MEDIUM' ? 'bg-amber-500/20 text-amber-400' : 'bg-red-500/20 text-red-400'
                      }`}>
